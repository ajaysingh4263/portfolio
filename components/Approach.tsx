  ...
  return (
    <section className="w-full py-20 ">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description ="we'll colaborate to map out your website's goals , target, audience and key functionalities
                         we'll discuss things like site structure , navigation, and content requirements "
        >
         <CanvasRevealEffect
         animationSpeed={5.1}
